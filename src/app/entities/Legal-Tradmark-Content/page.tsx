            ...
            <div className="col-lg-9">
              <div className="sec-header mb-5">
                ...
                <p>
                  ...
                  products, are trademarks of the Eclipse Foundation. In
                  addition the Eclipse Foundation logo is a trademark of the
                  Eclipse Foundation. This document captures a list of
                  trademarks claimed by the Eclipse Foundation.
                </p>
                <h2 className="tradmark-heding">Trademark Use</h2>
                <p>
                  The cometbid Foundation Trademark Usage Guidelines defines the
                  allowable use of Eclipse Foundation names, marks <br/> and logos.
